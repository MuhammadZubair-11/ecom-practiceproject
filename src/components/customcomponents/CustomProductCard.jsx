...
const CustomProductCard = ({ product }) => {
  ...
  const isalreadycart = cartitem.some((item) => item.id === product.id)
  console.log(isalreadycart,'ncjdcnjdn')
    ...
    <div className="bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 group">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between mt-5">
          ...
          <button onClick={handleaddtocart} className="bg-black text-white p-3 rounded-full hover:bg-gray-800 transition">
           {isalreadycart ? (
