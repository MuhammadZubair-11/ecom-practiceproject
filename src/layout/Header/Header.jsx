    ...
    <div className=" bg-gradient-to-br from-slate-100 via-gray-100 to-slate-200">
      <header className="backdrop-blur-md bg-white/80 border-b border-gray-200  px-6 py-4 flex items-center justify-between sticky top-0 z-40">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Wishlist */}
          <button className="relative text-gray-700 hover:text-pink-500 hover:bg-pink-100 p-3 rounded-2xl transition-all duration-300 shadow-sm">
          ...
          {/* Cart */}
          <button className="relative text-gray-700 hover:text-blue-500 hover:bg-blue-100 p-3 rounded-2xl transition-all duration-300 shadow-sm">
